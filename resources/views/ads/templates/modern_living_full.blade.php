<div style="width: 800px; height: 400px; background: #fff; font-family: 'Poppins', sans-serif; position: relative; overflow: hidden; display: flex; border: 1px solid #eee;">
    {{-- Left: Main Hero Image --}}
    <div style="width: 55%; height: 100%; position: relative;">
        <img src="{{ $data['image_main'] ?? 'https://placehold.co/440x400?text=Main+Living+Room' }}" style="width: 100%; height: 100%; object-fit: cover;">
        {{-- Text Overlay Box --}}
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            @foreach(['image_1', 'image_2', 'image_3', 'image_4'] as $key)
                <div style="width: 100%; aspect-ratio: 1; background: #f4f4f4; border-radius: 15px; overflow: hidden;">
                    <img src="{{ $data[$key] ?? 'https://placehold.co/150x150?text=Detail' }}" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            @endforeach
        </div>
        <div>
