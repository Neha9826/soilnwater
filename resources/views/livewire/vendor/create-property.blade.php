        ...
        <div class="max-w-5xl mx-auto pb-20">
            ...
            <div class="mb-8 flex justify-between items-center">
                <div>
                    ...
                    <h1 class="text-3xl font-extrabold text-gray-900">Add New Project</h1>
                    <p class="text-sm text-gray-500">This will be added to your profile portfolio.</p>
                </div>
            </div>
            ...
            <form wire:submit.prevent="save" class="space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input wire:model="title" type="text" placeholder="e.g. Doon Heights Luxury Apartments" class="w-full border-gray-300 rounded-lg p-2.5 border-2 focus:border-blue-500">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea wire:model="description" rows="4" class="w-full border-gray-300 rounded-lg p-2.5 border-2" placeholder="Describe the project highlights, location advantages, etc..."></textarea>
                        </div>
                    </div>
                </div>

                {{-- Location Section (Same as before) --}}
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                {{-- Floors & Amenities Sections remain the same --}}
                @include('livewire.vendor.partials.floor-plans') {{-- Assumed extracted or keep code here --}}
                            ...
                            <div class="p-6 bg-gray-50 rounded-xl border border-gray-300 relative shadow-sm hover:shadow-md transition" wire:key="floor-{{ $floor['id'] }}">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div class="md:col-span-1">
                                        ...
                                        <input wire:model="floors.{{ $index }}.floor_name" type="text" placeholder="e.g. Ground Floor" class="w-full border-gray-300 rounded-lg p-2.5 border text-sm bg-white">
                                    </div>
                                    <div class="md:col-span-1">
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-2">Area (sqft)</label>
                                        <input wire:model="floors.{{ $index }}.area_sqft" type="number" class="w-full border-gray-300 rounded-lg p-2.5 border text-sm bg-white">
                                    </div>
                                    <div class="md:col-span-1">
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-2">Rooms</label>
                                        <input wire:model="floors.{{ $index }}.rooms" type="number" class="w-full border-gray-300 rounded-lg p-2.5 border text-sm bg-white">
                                    </div>
                                    <div class="md:col-span-3">
                                        <label class="block text-xs font-bold text-gray-700 uppercase mb-2">Description</label>
                                        <textarea wire:model="floors.{{ $index }}.description" rows="2" class="w-full border-gray-300 rounded-lg p-2.5 border text-sm bg-white"></textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="flex justify-end pt-4 pb-12">
                    <button type="submit" class="bg-blue-600 text-white font-bold py-3 px-8 rounded-xl hover:bg-blue-700 shadow-lg flex items-center gap-2 transform transition hover:-translate-y-1">
                        <span wire:loading.remove>Save to Portfolio</span>
